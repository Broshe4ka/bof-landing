...
export const infoData = [
  {
    ...
    text: [
      'На острове вас встретят <strong>персонажи</strong>. которые помогут вам познакомиться с <strong>особенностями сервера</strong>. Вы <strong>узнаете тайны острова</strong> и познакомитесь с его интересными жителями и их историями. ',
